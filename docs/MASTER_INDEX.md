...
3. Product behavior in `03_WORKFLOWS.md`, `04_ROLE_PERMISSION_MATRIX.md`, `07_SCREEN_SPECIFICATIONS.md`, and `28_OLD_SCHOOL_USER_EXPERIENCE_CONTRACT.md`.
...
Existing code is not allowed to override a documented security or user-experience requirement. If the code contradicts this manual, open an issue and fix the code.
...
5. `28_OLD_SCHOOL_USER_EXPERIENCE_CONTRACT.md`
6. `19_DECISION_REGISTER.md`
7. `04_ROLE_PERMISSION_MATRIX.md`
8. `03_WORKFLOWS.md`
9. `05_DATA_MODEL_BLUEPRINT.md`
10. `08_SECURITY_PRIVACY_COMPLIANCE.md`
11. `15_IMPLEMENTATION_ROADMAP.md`
12. `16_DEFINITION_OF_DONE.md`
13. `20_AGENT_OPERATING_SYSTEM.md`
14. `22_EPIC_ACCEPTANCE_CRITERIA.md`
...
4. `27_BATALLA_OS_MASTER_ARCHITECTURE.md`
5. `28_OLD_SCHOOL_USER_EXPERIENCE_CONTRACT.md`
6. `implementation-reports/BATALLA_OS_PROGRAM_STATUS.md`
7. `implementation-reports/PHASE_1A_EXECUTION_CONTRACT.md` when working on intake, conflict review, consultation, or the Executive Command Center
...
- The interface must remain old-school, print-first, large-text, obvious, forgiving, and role-specific for Atty. Batalla, Dan Tejada, and the secretary.
- Atty. Batalla must be able to print and read complete, organized matter packets regardless of thickness.
